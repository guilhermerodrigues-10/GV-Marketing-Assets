          ...
          {columns.map(column => {
            ...
            return (
              <div 
                ...
                className={`w-80 flex-shrink-0 flex flex-col bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-800 h-full max-h-[calc(100vh-200px)] group/column`}
              >
